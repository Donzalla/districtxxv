...
const ImgPlaceholder = ({ style = {} }) => (
  <div style={{
    ...
    <span style={{
      ...
      letterSpacing: '0.18em', color: 'rgba(255,255,255,0.1)',
...
const ProductDetail = () => {
  ...
  const handleAddToCart = () => {
    ...
    // TODO: add to cart context / Supabase cart table
    console.log('Add to cart:', { product, selectedSize, quantity });
  };

  // Build image list — use images array if available, fall back to image_url
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#000', color: '#fff' }}>
      <style>{`
        ...
        @keyframes pd-pulse { 0%,100% { opacity:0.3; } 50% { opacity:0.7; } }
        ...
        .pd-thumb-placeholder.active { border-color: ${A.border}; }
        .pd-qty-btn {
        ...
        <div style={{ display: 'flex', gap: '12px', animation: 'pd-fadeUp 0.5s ease both' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
            {images.length > 0
              ...
              : [0, 1, 2].map(i => (
                  <div key={i}
                    className={`pd-thumb-placeholder${activeImg === i ? ' active' : ''}`}
                    onClick={() => setActiveImg(i)}
                  >
          ...
          <div style={{ marginBottom: '28px' }}>
            <div style={{
              ...
              <span style={{
                ...
                animation: sizeError ? 'pd-shake 0.3s ease' : 'none',
      ...
      {related.length > 0 && (
        <div style={{
          ...
          <div style={{
            ...
            color: A.tagText, marginBottom: '8px',
