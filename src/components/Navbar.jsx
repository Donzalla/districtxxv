...
// Category links — label must match exactly what's in Supabase
  ...
  return (
    <>
      <style>{`
        ...
        @keyframes nm-slideIn { from { transform:translateX(-100%); } to { transform:translateX(0); } }
        @keyframes nm-linkIn  {
      ...
      <nav style={{
        ...
        backgroundColor: '#000', position: 'sticky',
        top: 0, zIndex: 50, width: '100%',
      }}>
        <div style={{
          ...
          <div style={{ flex: 1, display: 'flex', justifyContent: 'flex-end', alignItems: 'center', gap: '20px' }}>
            <Link to="/profile" className="nm-icon-btn" style={{ textDecoration: 'none' }} aria-label="Profile">
              <User size={19} />
            </Link>
      ...
      <div style={{
        ...
        <div style={{ flex: 1, overflowY: 'auto', padding: '8px 24px 24px' }}>
          ...
          <div style={{
            fontFamily: "'DM Sans', sans-serif", fontSize: '9px', fontWeight: 300,
